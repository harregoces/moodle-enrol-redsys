...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'redsys'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/redsys/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_redsys', format_string($course->fullname));
